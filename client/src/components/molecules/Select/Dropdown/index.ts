...
import DropdwonOption from "molecules/Option/Dropdown";
...
const Dropdown: Molecule<DropdownProps> = ({
  ...
  const $downArrow = Icon(ShortDownArrow)({ width: 16, height: 16 });
  ...
  const $select = Div("dropdown-select")($placeholder, $downArrow, $list);
